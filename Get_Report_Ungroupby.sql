--select * from public.get_report_by_services('2021-01-01 00:00:00','2021-01-31 23:59:59 ')
	
select "ID", "Amount" Amount, ("ChargeCommission") CardOprComm, ("PurchaseCommission") PrvGateComm,("OtherCommissions") OtherComm,  ("Total") Total, "Agent" from (
 with commissions as 
	(			
				...
				select  tbb.id "Id",tbb.creationaction_id "Action",0 "ChargeCommission",0 "PurchaseCommission",coalesce(commission,0) "OtherCommissions"
					...
					where ha.performedat >='2021-01-11 21:35:15' and ha.performedat <'2021-01-11 21:37:27'
	)
	...
	select pp.external_id::text  "ID",pp.display_name "Service Name",pp.description "Description",tbb.id "Process ID", gtd.amount_to_send "Amount", t."ChargeCommission",t."PurchaseCommission",t."OtherCommissions",gtd.amount_to_send+t."ChargeCommission"+t."PurchaseCommission" "Total",'17' "Agent" from commissions t 
	...
	union 
	select pp.external_id::text  "ID",pp.display_name "Service Name",pp.description "Description",tbb.id "Process ID", gtd.amount_to_send "Amount", t."ChargeCommission",t."PurchaseCommission",t."OtherCommissions",gtd.amount_to_send+t."ChargeCommission"+t."PurchaseCommission" "Total",'18' "Agent" from commissions t 
